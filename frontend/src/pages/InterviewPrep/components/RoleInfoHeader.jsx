...
const RoleInfoHeader = ({
  ...
  return (
    ...
    <div className='container mx-auto px-10 md:px-0'>
        ...
        <div className="w-[40vw] h-[30vw] h-[200px] flex items-center justify-center bg-white overflow-hidden absolute top-0 right-0 ">
            ...
            <div className="w-16 h-16 bg-cyan-300 blur-[65px] animate-blob1"></div>
